    ...
    <div className="flex flex-col bg-black text-white selection:bg-orange-500/30 font-sans tracking-tight leading-none overflow-x-hidden">
      ...
      <section id="process" className="py-80 px-6 bg-[#030303] border-t border-white/5">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-32 items-center">
           ...
           <div className="grid grid-cols-2 gap-4">
              <div 
                className="aspect-square bg-neutral-950 relative overflow-hidden grayscale group cursor-zoom-in border border-white/5"
      ...
      <footer className="pt-24 md:pt-40 pb-40 px-6 text-center bg-black">
        <div className="flex flex-col items-center">
          <div className="w-[200px] md:w-[320px] opacity-100 mb-24 md:mb-40 relative z-0">
            <img 
              src="https://claw.starryambition.com/8711438752/202603/thother-combined-logo-footer-v29.jpg" 
